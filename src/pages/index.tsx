        ...
        <section className="grid h-full  w-full  grid-cols-1 md:grid-cols-12">
                    ...
                    <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-12 lg:h-40">
                      ...
                      <div className="col-span-8 flex flex-col space-y-2">
                        ...
                        <p className="break-normal text-sm text-gray-500">
                          ...
                          elit. Provident ullam, adipisci blanditiis laudantium
                          soluta quisquam asperiores sed exercitationem
                          voluptatibus magnam.Lorem ipsum dolor sit amet cidunt
                          eum aperiam cumque error excepturi
                        </p>
                      </div>
                      {/* rightr side IMAGE */}
          ...
          <aside className="col-span-4 flex  w-full flex-col p-6 ">
                  ...
                  <div key={i} className="flex items-center space-x-5">
                    ...
                    <div>
                      ...
                      <div className="text-xs">
                        Lorem ipsum dolor sit, amet consectetur adipisicing
                        elit. Alias a laboriosam sint perferendis magnam vel
                        animi. Velit quas reiciendis distinctio ipsum doloribus
                        rem. Consectetur illum modi dignissimos dolor hic vero.
                      </div>
                    </div>
                    <div>
            ...
            <div className="sticky top-20">
              <h3 className="my-3 font-semibold capitalize">
                your reading list
              </h3>
              <div className="flex flex-col space-y-4">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="group flex items-center space-x-6">
                    ...
                    <div className="flex w-3/5 flex-col space-y-2">
                      ...
                      <div>
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Possimus assumenda nobis sapiente non quia!
                      </div>
